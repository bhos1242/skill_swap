  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Find Your Perfect Skill Exchange Partner</CardTitle>
            <CardDescription>
              Search and filter to discover people who can teach what you want to learn
            </CardDescription>
          </CardHeader>
          <CardContent>
          {/* Basic Search Row */}
          <div className="grid md:grid-cols-4 gap-4 mb-4">
            ...
            <div>
              ...
              <Select value={sortBy} onValueChange={(value: "compatibility" | "rating" | "recent") => setSortBy(value)}>
                <SelectTrigger>
